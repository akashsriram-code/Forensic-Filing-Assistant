...
export const DEFAULT_RADAR_WATCHLISTS: RadarWatchlist[] = [
    ...
    },
    {
        ...
        items: [
            ...
            { ticker: 'AVGO', label: 'Broadcom', aliases: ['BROADCOM', 'BROADCOM INC'] },
            { ticker: 'PLTR', label: 'Palantir', aliases: ['PALANTIR', 'PALANTIR TECHNOLOGIES'] },
            { ticker: 'LITE', label: 'Lumentum', aliases: ['LUMENTUM', 'LUMENTUM HOLDINGS'] },
            { ticker: 'WDC', label: 'Western Digital', aliases: ['WESTERN DIGITAL', 'WESTERN DIGITAL CORP'] },
            { ticker: 'APP', label: 'AppLovin', aliases: ['APPLOVIN', 'APP LOVIN'] },
            { ticker: 'STX', label: 'Seagate', aliases: ['SEAGATE', 'SEAGATE TECHNOLOGY'] },
            { ticker: 'COHR', label: 'Coherent', aliases: ['COHERENT', 'COHERENT CORP'] },
            { ticker: 'CGNX', label: 'Cognex', aliases: ['COGNEX', 'COGNEX CORP'] },
            { ticker: 'CRWV', label: 'CoreWeave', aliases: ['COREWEAVE', 'CORE WEAVE'] },
        ],
    },
    {
        key: 'defense',
        label: 'Defense',
        description: 'Defense contractors, aerospace, and national security technology.',
        items: [
            { ticker: 'LMT', label: 'Lockheed Martin', aliases: ['LOCKHEED MARTIN', 'LOCKHEED MARTIN CORP'] },
            { ticker: 'NOC', label: 'Northrop Grumman', aliases: ['NORTHROP GRUMMAN', 'NORTHROP GRUMMAN CORP'] },
            { ticker: 'GD', label: 'General Dynamics', aliases: ['GENERAL DYNAMICS', 'GENERAL DYNAMICS CORP'] },
            { ticker: 'RTX', label: 'Raytheon', aliases: ['RAYTHEON', 'RTX CORP', 'RAYTHEON TECHNOLOGIES'] },
            { ticker: 'LDOS', label: 'Leidos Holdings', aliases: ['LEIDOS', 'LEIDOS HOLDINGS'] },
            { ticker: 'AVAV', label: 'AeroVironment', aliases: ['AEROVIRONMENT', 'AERO VIRONMENT'] },
            { ticker: 'AXON', label: 'Axon', aliases: ['AXON', 'AXON ENTERPRISE'] },
            { ticker: 'HWM', label: 'Howmet', aliases: ['HOWMET', 'HOWMET AEROSPACE'] },
            { ticker: 'RKLB', label: 'Rocket Lab', aliases: ['ROCKET LAB', 'ROCKETLAB', 'ROCKET LAB USA'] },
            { ticker: 'LHX', label: 'L3Harris', aliases: ['L3HARRIS', 'L3 HARRIS', 'L3HARRIS TECHNOLOGIES'] },
            { ticker: 'ATRO', label: 'Astronics', aliases: ['ASTRONICS', 'ASTRONICS CORP'] },
            { ticker: 'ACHR', label: 'Archer Aviation', aliases: ['ARCHER AVIATION', 'ARCHER'] },
        ],
    },
    {
        key: 'utilities-power',
